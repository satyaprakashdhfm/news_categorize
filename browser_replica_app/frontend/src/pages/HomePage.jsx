  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-gray-900 transition-colors">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 border border-blue-200 dark:border-blue-700">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold text-secondary-900 dark:text-white">Browser-based Scrape Replica</h3>
              <p className="text-sm text-secondary-600 dark:text-gray-300 mt-1">
                Open the isolated browser flow where each saved result is tagged with source <strong>browser_satya</strong>.
              </p>
            </div>
            <Link
              to="/browser-scrape"
              className="inline-flex items-center justify-center px-5 py-3 rounded-lg font-medium bg-blue-600 hover:bg-blue-700 text-white"
            >
              Open Browser Scrape
            </Link>
          </div>
